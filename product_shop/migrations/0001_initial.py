    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order Receiving', 'Order Receiving'), ('Order Processing', 'Order Processing'), ('On The Way', 'On The Way')], default='Order Receiving', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fullname', models.CharField(blank=True, default=None, max_length=255, null=None)),
                ('quantity', models.IntegerField(default=0)),
